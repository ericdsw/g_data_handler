        ...
        <AppBar position="fixed" color="primary"
            ...
            >
                ...
                <Typography variant='body1'>
                    Depending on the use case, forms can contain inputs
                    with the following formats:&nbsp;
                    <br /><br />

                    <Typography variant='h6' className={classes.blueText}>Normal text</Typography>
                    Account for the mayority of cases and their specific format
                    will depend on what the input is for.
                    {createInput('foo', textInputSchema, 'Some Text', () => {})}
                    <br /><br />

                    <Typography variant='h6' className={classes.amberText}>Positions</Typography>
                    A position can either be a json with both x and y defined, or a Position2D node
                    inside the map, in which case only the node name must be defined.
                    {createInput('bar', positionInputSchema, '{"x": 200, "y": 300} or NodeName', () => {})}
                    <br /><br />

                    <Typography variant='h6' className={classes.yellowText}>Position Arrays</Typography>
                    A position array is a list of Position2Ds on the map, and is defined as a comma
                    separated list the position's node names.
                    {createInput('baz', positionArrayInputSchema, 'Position1, Position2, Position3', () => {})}
                    <br /><br />

                    <Typography variant='h6' className={classes.greenText}>Node Target</Typography>
                    ...
                    <ul>
                        ...
                        <li>
                            <code classname={classes.codetext}>:NodeName</code>&nbsp;
